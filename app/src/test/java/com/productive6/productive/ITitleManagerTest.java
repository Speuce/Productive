...
import com.productive6.productive.logic.rewards.impl.DefaultITitleManager;
...
public class ITitleManagerTest {
    ...
    ITitleManager ITitleManager;

    @Before
    public void init(){
        String[] tempTitles = {"TEST1", "TEST2", "TEST3"};
        int[] tempVals = {1, 2, 3};
        ITitleManager = new DefaultITitleManager(data,tempTitles,tempVals);
    ...
    public void testAllTitleStrings(){
        ...
        List<Title> testList = ITitleManager.getTitleOptions();
    ...
    public void testValidTitle(){
        ...
        ITitleManager.setTitle("TEST2");

        assertTrue("The title has not been successfully set to TEST2", ITitleManager.getTitleAsString().equals("TEST2"));
    ...
    public void testInvalidTitle(){
        ...
        EventDispatch.dispatchEvent(new UserLoadedEvent(new User(0, 10, 0)));
        ITitleManager.setTitle("TEST2");
        assertTrue("The title was not successfully set to TEST2", ITitleManager.getTitleAsString().equals("TEST2"));

        ITitleManager.setTitle("INVALID");
        assertTrue("The title was changed", ITitleManager.getTitleAsString().equals("TEST2"));
    ...
    public void testEventUpdating() {
        ...
        assertTrue("Expected to have only 1 title option", ITitleManager.getTitleOptions().size() == 1 );

        EventDispatch.dispatchEvent((new UserUpdateEvent(new User(0,3,0))));

        assertTrue("Expected to have 3 title options", ITitleManager.getTitleOptions().size() == 3 );
